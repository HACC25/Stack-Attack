...
export type ApiChat = {title:string; chat_id: string; created_at: string };
...
export type MessageResponse = {message_id:string, sent_by_user:boolean, content:string, metadata:object, created_at:string}
